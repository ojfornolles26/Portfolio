    ...
    <div className="bento-card">
      <div>
        ...
        <div className="max-w-3xl space-y-5 text-sm text-stone-600 dark:text-stone-300 leading-relaxed font-sans">
          ...
          <p>
            Currently a Software Developer Intern at SugboDoc Technologies Inc., building full-stack web applications on-site for a healthcare technology platform. Also completing a Front-End AI Engineering Internship at FlyRank AI, developing React and Next.js applications with modern component architecture and deployment workflows. As COO of SWUdevs, I lead a 150+ member developer community, coordinating cross-functional teams and delivering workshops on web development and UI/UX best practices.
          </p>
