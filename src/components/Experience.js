...
const EXPERIENCE_ITEMS = [
  {
    ...
    bullets: [
      "Build and maintain full-stack web applications on-site, contributing to SugboDoc Technologies Inc.'s healthcare technology platform.",
  ...
  },
  {
    ...
    period: "Jun 2026 – Present",
    bullets: [
      "Help manage community operations, coordinate team communications, and facilitate peer-to-peer and Big Brother / Big Sister support initiatives for student developers.",
      "Speak at and facilitate technical workshops for the community, with a focus on AI.",
      "Organize workshop events and technical initiatives, helping student builders develop practical skills for software projects.",
    ],
  },
  {
...
export function ExperienceCard() {
  return (
    <div className="editorial-section">
      <div className="editorial-header">Where I've Contributed</div>
      <div className="pt-2">
...
export function EducationCard() {
  return (
    <div className="editorial-section">
      <div className="editorial-header">Where I Learned</div>
      <div className="pt-2">
